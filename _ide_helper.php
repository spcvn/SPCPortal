...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \SPCVN\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SPCVN\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function command($signature, $callback){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SPCVN\Console\Kernel::command($signature, $callback);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SPCVN\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SPCVN\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SPCVN\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SPCVN\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SPCVN\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SPCVN\Console\Kernel::bootstrap();
        }
    ...
    class Authy extends \SPCVN\Services\Auth\TwoFactor\Facade{
        
        /**
         * Determine if the given user has two-factor authentication enabled.
         *
         * @param \SPCVN\Services\Auth\TwoFactor\TwoFactorAuthenticatable $user
         * @return bool 
         * @static 
         */
        public static function isEnabled($user){
            return \SPCVN\Services\Auth\TwoFactor\Authy::isEnabled($user);
        }
        ...
        public static function register($user){
            return \SPCVN\Services\Auth\TwoFactor\Authy::register($user);
        }
        ...
        public static function tokenIsValid($user, $token){
            return \SPCVN\Services\Auth\TwoFactor\Authy::tokenIsValid($user, $token);
        }
        ...
        public static function delete($user){
            return \SPCVN\Services\Auth\TwoFactor\Authy::delete($user);
        }
