...
@section('content')
	...
	{{ HTML::script('spcvn/ace/js/jquery.bootstrap-duallistbox.min.js') }}
	{{ HTML::script('spcvn/ace/js/jquery.raty.min.js') }}
	{{ HTML::script('spcvn/ace/js/bootstrap-multiselect.min.js') }}
	{{ HTML::script('spcvn/ace/js/select2.min.js') }}
	{{ HTML::script('spcvn/ace/js/jquery-typeahead.js') }}
