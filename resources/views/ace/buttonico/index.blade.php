...
&lt;/a&gt;
						...
						<tr>
							<td>
								<a href="#" class="btn btn-app btn-primary no-radius pull-left">
							...
							<td>
								<pre class="prettyprint linenums">&lt;a href="#" class="btn btn-app btn-primary no-radius"&gt;
...
&lt;/a&gt;</pre></td>
						...
						<tr>
							<td>
								<a href="#" class="btn btn-app btn-success pull-left">
...
&lt;/a&gt;
						...
						<tr>
							<td>
								<button class="btn btn-app btn-warning pull-left">
...
&lt;/button&gt;
						...
						<tr>
							<td>
								<a href="#" class="btn btn-app btn-info btn-sm no-radius pull-left">
...
&lt;/a&gt;
						...
						<tr>
							<td>
								<button class="btn btn-app btn-danger btn-sm pull-left">
...
&lt;/button&gt;
						...
						<tr>
							<td>
								<button class="btn btn-app btn-purple btn-sm pull-left">
...
&lt;/button&gt;
						...
						<tr>
							<td>
								<button class="btn btn-app btn-pink btn-sm pull-left">
...
&lt;/button&gt;
						...
						<tr>
							<td>
								<button class="btn btn-app btn-inverse btn-xs pull-left">
								<i class="ace-icon fa fa-lock bigger-160"></i>Lock
							</button>
							</td>
							<td>
								<pre class="prettyprint linenums">&lt;button class="btn btn-app btn-inverse btn-xs"&gt;
	&lt;i class="ace-icon fa fa-lock bigger-160"&gt;&lt;/i&gt;Lock
&lt;/button&gt;</pre></td>
						</tr>
						<tr>
							...
							<td>
								<pre class="prettyprint linenums">&lt;button class="btn btn-app btn-grey btn-xs radius-4"&gt;
	&lt;i class="ace-icon fa fa-floppy-o bigger-160"&gt;&lt;/i&gt;Save
	&lt;span class="badge badge-transparent"&gt;
		&lt;i class="light-red ace-icon fa fa-asterisk"&gt;&lt;/i&gt;
	&lt;/span&gt;
