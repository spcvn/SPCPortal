...
- list item 3</textarea>
	...
	{{ HTML::script('spcvn/ace/js/markdown.min.js') }}
	{{ HTML::script('spcvn/ace/js/bootstrap-markdown.min.js') }}
		...
		jQuery(function($){
			...
			$('#editor2').css({'height':'200px'}).ace_wysiwyg({
				toolbar_place: function(toolbar) {
					return $(this).closest('.widget-box').find('.widget-header').prepend(toolbar).find('.wysiwyg-toolbar').addClass('inline');
				},
				toolbar:
				[
					'bold',
