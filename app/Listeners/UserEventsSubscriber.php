...
use SPCVN\Activity;
use SPCVN\Events\Settings\Updated as SettingsUpdated;
use SPCVN\Events\User\Banned;
use SPCVN\Events\User\ChangedAvatar;
use SPCVN\Events\User\Created;
use SPCVN\Events\User\Deleted;
use SPCVN\Events\User\LoggedIn;
use SPCVN\Events\User\LoggedOut;
use SPCVN\Events\User\Registered;
use SPCVN\Events\User\RequestedPasswordResetEmail;
use SPCVN\Events\User\ResetedPasswordViaEmail;
use SPCVN\Events\User\TwoFactorDisabled;
use SPCVN\Events\User\TwoFactorDisabledByAdmin;
use SPCVN\Events\User\TwoFactorEnabled;
use SPCVN\Events\User\TwoFactorEnabledByAdmin;
use SPCVN\Events\User\UpdatedByAdmin;
use SPCVN\Events\User\UpdatedProfileDetails;
...
class UserEventsSubscriber
{
    ...
    {
        $class = 'SPCVN\Listeners\UserEventsSubscriber';
