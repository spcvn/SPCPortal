...
class EloquentRoleTest extends FunctionalTestCase
{
    ...
    {
        $this->expectsEvents(\SPCVN\Events\Role\Updated::class);
    ...
    {
        $this->expectsEvents(\SPCVN\Events\Role\Deleted::class);
    ...
    {
        $role = factory(Role::class)->create();
        $permissions = factory(\SPCVN\Permission::class)->times(2)->create();
