...
class ProfileControllerTest extends FunctionalTestCase
{
    ...
    {
        $file = storage_path("app/SPCVN-test.php");
    ...
    {
        $this->expectsEvents(\SPCVN\Events\User\TwoFactorEnabled::class);
    ...
    {
        $this->expectsEvents(\SPCVN\Events\User\TwoFactorDisabled::class);
    ...
    {
        $logger = app(\SPCVN\Services\Logging\UserActivity\Logger::class);
